"""
PLOT UNCALIBRATED AND CALIBRATED MAGNETOMETER MEASUREMENTS
...
Adapted from: Michael Wrona
https://github.com/michaelwro/mag-cal-example
...
rawData = np.genfromtxt('exampleData.txt', delimiter='\t')  # Read raw measurements
